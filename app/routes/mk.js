...
Track.findOneAndUpdate({PID: '5'}, {$set:{UserLat:la, UserLong:ln, DeviceId:m, DeviceGeo:mip }},function(err, doc){
    if(err){
        console.log("Something wrong when updating in DB!");
    }else{
      console.log("successfully updated in findOneAndUpdate");
    }
  });
 ...
 // Track.findOneAndUpdate({PID: '4'}, {$set:{UserLat:la, UserLong:ln, DeviceId:m, DeviceGeo:mip }},function(err, doc){
 //    if(err){
 //        console.log("Something wrong when updating in DB!");
 //    }else{
 //      console.log("successfully updated");
